...
{                               
  FILE *archivoBinario;         
  int i, total, Cicle, Eleccion_1, Eleccion_2, Eleccion_3, Eleccion_4;
	...
	switch(Eleccion_1)
	{
		...
		case 2:
			...
			if(Eleccion_2==1)
			{
    			...
    			scanf("%d",&Eleccion_4);
    			modificarcampo(archivoBinario, Eleccion_4, Eleccion_3, total);
   			}
   			if(Eleccion_2==2)
   			{
   			    total=mostrar(archivoBinario);
    			if(total==0)
    			{
   				...
   				printf("\nSeleccione el numero del contacto que se modificara: ");
   				scanf("%d", &Eleccion_3);
   				modificarcont(archivoBinario, Eleccion_3, total);
			}
			break;
		case 3:
			system("cls");
